...
class SharedPreferencesDataSource(
    ...
    override fun isPositionLocked(): Flow<Boolean> =
        getPreferenceFlow(AppConstants.KEY_POSITION_LOCKED, AppConstants.DEFAULT_POSITION_LOCKED) { prefs, key, default ->
            prefs.getBoolean(key, default)
        }

    override suspend fun setPositionLocked(locked: Boolean) {
        prefs.edit().putBoolean(AppConstants.KEY_POSITION_LOCKED, locked).apply()
    }
